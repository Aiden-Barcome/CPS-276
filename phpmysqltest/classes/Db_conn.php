...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'abarcome';//this will be your WCC username
      $dbUsr = 'abarcome';//this will be your WCC username
      $dbPass = 'Gdq4GdhG5a5g';//this will be the password found in the video.
