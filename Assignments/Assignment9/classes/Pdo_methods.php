<?php
    ...
    class PdoMethods extends Db_conn {
        ...
        public function selectBinded($sql, $bindings){
            ...
            // I CREATE A TRY CATCH BLOCK TO CATCH ANY ERRORS THAT MIGHT ARISE AND RETURNS AN ERROR MESSAGE.
            try{
                $this->db_connection();
        ...
        /* THIS FUNCTION DOES THE SAME AS THE ABOVE BUT DOES NOT NEED ANY BINDED PARAMETERS ARE NO PARAMETERS ARE PASSED */
