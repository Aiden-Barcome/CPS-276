...
if (isset($_POST['SubmitButton'])){
    ...
    mkdir("/Assignment5/classes/directories/$folderName", true);
    if (!mkdir("C:/xampp/htdocs/Assignment5/classes/directories/$folderName")){
        $errorMessage="The directory could not be created.";
    }
    touch("/Assignment5/classes/directories/$folderName/readme.txt", true);
    ...
    if(file_exists("readme.txt")){
        $successLink="<a href="."/Assignment5/classes/directories/$folderName/readme.txt"." target="."_blank".">Path where the file is located</a>";
    }
}
?>